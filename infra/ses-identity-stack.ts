...
import { CnameRecord, type IHostedZone, MxRecord, TxtRecord } from "aws-cdk-lib/aws-route53";
import { DkimIdentity, EasyDkimSigningKeyLength, EmailIdentity, Identity, MailFromBehaviorOnMxFailure } from "aws-cdk-lib/aws-ses";
...
export class SESIdentityStack extends Stack {
  ...
  constructor(
    ...
    for (const dkimRecord of this.emailIdentity.dkimRecords) {
      new CnameRecord(this, `stuff-email-dkim-record-${this.emailIdentity.dkimRecords.indexOf(dkimRecord)}`, {
        zone,
