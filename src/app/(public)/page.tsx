...
export default setupPage({
  async Component() {
    return (
      <div className={stack({gap: "md", direction: "col"})}>
        <Section maxWidth="md" className={css({p: "medium"})}>
        ...
        <Section maxWidth="md" className="animate-in ease-out slide-in-from-bottom-10 duration-700 grid grid-cols-3 w-full max-w-[1000px] gap-space-lg max-md:grid-cols-1 max-md:grid-rows-3">
          ...
          <Card p="md" className="animate-in ease-out duration-700 fade-in flex flex-col justify-between">
            ...
            <Link href="/whitepaper" className={cn("ml-auto", button({variant: "link"}))}>Whitepapers</Link>
          </Card>
        ...
        <Section maxWidth="lg" className="animate-in ease-out slide-in-from-bottom-40 duration-700 fade-in bg-background2 rounded-[50px] w-full mx-auto">
          <Section maxWidth="md" className={stack({direction: "col", align: "center"})} style={{overflow: "hidden", padding: "1rem"}}>
            ...
            <div className={boxGrid}>
              <Card className={cn(conversations, shadow({size: "large"}), "bg-background w-full border-none p-8 shadow-lg")}>
                <H2>Conversations</H2>
