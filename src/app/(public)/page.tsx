...
import { Separator } from "packages/components/lib/separator";
    ...
    return (
      <>
        <Section className="flex justify-between items-center md:pt-20 max-md:flex-col max-md:items-center w-full">
          <HeroTitle
            className="pt-8 motion-reduce:animate-in max-md:text-center fade-in duration-500 slide-in-from-top-4 ease-out"
            title={<>
        ...
        <Section  className="grid grid-cols-3 w-full max-w-[1000px] gap-space-lg max-md:grid-cols-1 max-md:grid-rows-3 md:pb-12">
          ...
          <Card className="flex flex-col justify-between">
            ...
            <Link href="/whitepaper" className={cn("ml-auto", buttonVariants({variant: "outline"}))}>Whitepapers</Link>
          </Card>
          <Card className="flex flex-col justify-between">
            <div>
              <H2>Feature rich</H2>
            ...
            <a href="#features" className={cn("ml-auto", buttonVariants({variant: "outline"}))}>Show features</a>
          </Card>
        </Section>
        <Separator />
        <div className="bg-background2 border-b border-border">
          <Section highSpace className="flex flex-col items-center">
            <P>Stuff is a mail service</P>
            <H1 id="features">Stuff Features</H1>
            <div className={boxGrid}>
              <Card className={cn(conversations, "shadow bg-background w-full border-none p-8")} noPadding>
                <H2>Conversations</H2>
              ...
              <Card className={cn(extensions,"shadow bg-background border-none hover:bg-card")} noPadding>
                <Link href="/extensions">
                  ...
                  <img src="/extensions.png"  className="w-[70%] border-t border-l rounded-tl-lg border-border ml-auto mt-6" />
                </Link>
              </Card>
            </div>
          </Section>
        </div>
        <Section highSpace className="flex flex-col gap-6 max-w-[1000px]">
          <h2 className="text-4xl font-bold">Guarranties by <StuffBranding />:</h2>
