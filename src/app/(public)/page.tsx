  ...
  async Component() {
    return (
      <div className={stack({gap: "xl", direction: "col"})}>
        <Section maxWidth="md" className={css({p: "medium", paddingBottom: 'none'})}>
          <div style={{width: '100%'}} className={cn(stack({justify: "between", align: "center", direction: {
            mobile: "col",
            desktop: "row"
          }}))}> 
            <HeroTitle
        ...
        <Section maxWidth="lg" className={cn(css({bg: "bg2", mX: "auto", width: "full"}),border({rounded: "xl"}))}>
          <Section maxWidth="md" className={stack({direction: "col", align: "center"})} style={{overflow: "hidden", padding: "1rem"}}>
            ...
            <div className={boxGrid}>
              ...
              <Card className={cn(folders, shadow({size: "large"}),"bg-background border-none p-8")}>
                <P>Extension:</P>
                <H2>Folder Rules</H2>
              ...
              <Card className={cn(extensions,shadow({size: "large"}), "bg-background border-none hover:bg-card")}>
        ...
        <Section maxWidth="xs">
          ...
          <Accordion type="multiple">
            ...
            <AccordionItem value="item-2">
              ...
              <AccordionContent>
                Stuff mails design is to be secure and private. We use end-to-end encryption to keep your emails safe. This means that its impossible for us as service owners to read your messages.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </Section>
