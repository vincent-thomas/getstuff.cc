  ...
  async Component() {
    return (
      <>
        ...
        <Section className="animate-in ease-out duration-1000 fade-in grid grid-cols-3 w-full max-w-[1000px] gap-space-lg max-md:grid-cols-1 max-md:grid-rows-3 md:pb-24">
        ...
        <div className="animate-in ease-out slide-in-from-bottom-10 duration-700 fade-in bg-background2 border-y-2 border-border rounded-t-[50px] border-border max-w-[1400px] w-full mx-auto relative">
          <Section highSpace className="flex flex-col items-center overflow-hidden">
            ...
            <div className={boxGrid}>
              <Card className={cn(conversations, "bg-background w-full border-none p-8 shadow-lg")}>
                ...
                <img src="/conversationv2.png" alt="" className="rounded-xl shadow-xl mt-4 md:skew-y-[-12deg] md:rotate-[8deg] md:w-[80%] w-full ml-auto mr-2 aspect-square border-border border" />
              </Card>
